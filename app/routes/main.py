...
def dashboard():
    ...
    fig5 = px.bar(age_counts, x='age_group', y='count', title='Age Group Report Count',
    ...
    fig6 = px.scatter_geo(country_counts, locations='iso3', size='count',
                          hover_name='country', title='Report Count by Country',
                          color='count', color_continuous_scale='Reds',
                          projection='natural earth')
    fig6.update_layout(template='plotly_dark', height=420,
                       geo=dict(showframe=False, showcoastlines=True,
                                showland=True, landcolor='#1e293b', bgcolor='#0f172a'))
...
def korea_dashboard():
    ...
    df.columns = ['rank', 'sym_2024', 'cnt_2024', 'sym_2023', 'cnt_2023',
                  'sym_2022', 'cnt_2022', 'sym_2021', 'cnt_2021',
                  'sym_2020', 'cnt_2020', 'sym_2019', 'cnt_2019']

    fig1 = px.bar(df.head(10), x='sym_2024', y='cnt_2024',
                  title='Korea 2024 Top 10 ADR',
    ...
    df10 = df.head(10)
    fig3 = go.Figure()
    fig3.add_trace(go.Bar(x=df10['sym_2024'], y=df10['cnt_2024'],
                          name='2024', marker_color='#38bdf8'))
    fig3.add_trace(go.Bar(x=df10['sym_2024'], y=df10['cnt_2023'],
                          name='2023', marker_color='#a78bfa'))
    fig3.update_layout(barmode='group', title='2024 vs 2023 Top 10 ADR',
                       xaxis_tickangle=-45, template='plotly_dark', height=420)
