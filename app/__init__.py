...
def create_app():
    ...
    predict_input = api.model(
        "PredictInput",
        {
            "drugname": fields.String(
                required=True, description="Drug Name", example="METHOTREXATE"
            ),
            "reaction": fields.String(
                required=True, description="Adverse Reaction", example="FATIGUE"
            ),
